...
public class AllDataServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<OrderDetail> orderDetails = orderDetailBean.findAll();
            List<Receipt> receipts = receiptBean.findAll();
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("/allData.jsp");
